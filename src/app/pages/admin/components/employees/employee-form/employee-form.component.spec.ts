    ...
    <div class="modal-overlay">
      <div class="modal-container">
        ...
        <form [formGroup]="employeeForm" (ngSubmit)="onSubmit()">
          ...
          <button
            type="submit"
            [disabled]="employeeForm.invalid || (!isEditMode && !selectedFile)"
            class="submit-button">
...
export class EmployeeFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.dialogTitle = this.isEditMode ? 'Редактировать сотрудника' : 'Добавить сотрудника';
  ...
  onSubmit(): void {
    if (this.employeeForm.valid && (this.isEditMode || this.selectedFile)) {
